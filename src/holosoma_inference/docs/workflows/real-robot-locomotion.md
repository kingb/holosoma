...
- **Mixed input**: Use `--task.velocity-input` and `--task.other-input` individually for mixed setups (e.g., ROS2 velocity + keyboard commands). See the [Input Sources](../../README.md#input-sources) section for details.
