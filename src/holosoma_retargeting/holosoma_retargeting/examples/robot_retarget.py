...
def build_retargeter_kwargs_from_config(
    ...
    kwargs = {
        ...
        "activate_foot_lock_windows": retargeter_config.activate_foot_lock_windows,
        ...
        "foot_lock_windows": retargeter_config.foot_lock_windows,
        "z_floor": retargeter_config.z_floor,
        "z_tol": retargeter_config.z_tol,
